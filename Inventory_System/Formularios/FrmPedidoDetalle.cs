...
namespace Inventory_System.Formularios
{
    public partial class FrmPedidoDetalle : Form
    {
        ...
        private void BtnAceptar_Click(object sender, EventArgs e)
        {
            if (ValidarDatos())
            {
                DataRow NuevaFila = Locales.ObjetosGlobales.MiFormGestionPedido.DtListaProductos.NewRow();
                ...
                Locales.ObjetosGlobales.MiFormGestionPedido.DtListaProductos.Rows.Add(NuevaFila);
